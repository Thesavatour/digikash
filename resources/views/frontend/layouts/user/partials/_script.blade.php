...
{{-- Theme Main Script --}}
@php($dashboardMainJsVersion = config('app.version').'-'.filemtime(public_path('frontend/js/dashboard-main.js')))
<script src="{{ asset('frontend/js/dashboard-main.js?v='.$dashboardMainJsVersion) }}"></script>
