...
<div class="p2p-offer-section" id="p2pPaymentMethodsSection">
    <div class="p2p-offer-section__head">
        ...
        <a href="{{ route('user.p2p.payment-accounts.index') }}" class="btn btn-light-primary btn-sm p2p-btn-xs p2p-payment-head__action">
            <span>@lang('Manage Accounts')</span>
    ...
    <div class="p2p-offer-methods">
        ...
        <div class="p2p-method-toolbar mb-3">
            ...
            <div class="p2p-method-toolbar__filters">
                <div class="p2p-method-toolbar__control p2p-method-toolbar__country">
                    <label class="visually-hidden" for="p2pPaymentMethodsCountry">@lang('Filter payment methods by country')</label>
                ...
                <div class="p2p-method-toolbar__control p2p-method-toolbar__search">
                    <label class="visually-hidden" for="p2pPaymentMethodsSearch">@lang('Search payment methods')</label>
                    <span class="p2p-method-toolbar__search-icon" aria-hidden="true"><i class="fas fa-search"></i></span>
                    <input type="text" id="p2pPaymentMethodsSearch" class="form-control form-control-sm p2p-method-toolbar__search-input" placeholder="@lang('Search payment methods')">
                </div>
            </div>
        </div>
                                ...
                                <span class="p2p-method-card__content">
                                    <span class="p2p-method-card__top">
                                        <span class="p2p-method-card__title-group">
                                            <span class="p2p-method-card__title-line">
                                                <span class="p2p-method-card__name">{{ $m->name }}</span>
                                            </span>
                                            <span class="p2p-method-card__scope {{ $methodScopeClass }}">{{ $methodScopeLabel }}</span>
                                        </span>
                                        <span class="p2p-method-card__check" aria-hidden="true"><i class="fas fa-check"></i></span>
                                        @if($methodEnabled)
