    ...
    <div class="card border-0 shadow-sm p-2" style="border-radius: 12px;">
        ...
        <div class="quick-actions" data-collapsible="1">
            ...
            @if($remittanceMenuVisible)
                <a href="{{ route('user.remittance.create') }}" class="qa-item {{ isActive('user.remittance.create') }}" role="button">
                    <span class="qa-icon"><x-icon name="currency-exchange" class="icon"/></span>
                    <span>{{ __('Remittance') }}</span>
                </a>
                <a href="{{ route('user.beneficiaries.index') }}" class="qa-item {{ request()->routeIs('user.beneficiaries.*') ? 'active' : '' }}" role="button">
                    <span class="qa-icon"><x-icon name="sidebar-users" class="icon"/></span>
