                                        ...
                                        <button type="button"
                                            ...
                                            <div class="inner">
                                                <div class="gc-template-card__art">
                                                    <x-gift-card-design :preset="$t->preset_key" :amount="$t->default_amount ?: 50" :recipient="__('Recipient')" sender="{{ $defaultSender ?: 'You' }}" :width="216" :image="$t->image" :background-color="$t->background_color" :text-color="$t->text_color" :ribbon-text="$t->ribbon_text"/>
                                                </div>
    ...
    <script>
        ...
        (function ($) {
            ...
            function renderCard(opts) {
                ...
                const motif = imageUrl ? '' : renderMotif(def.motif, uid);
                const photoLayer = imageUrl
                    ...
                    : '';
                const cardBg = imageUrl ? '#0F172A' : def.bg;
                ...
                return `<div style="width:${w}px; height:${h}px; position:relative; background:${cardBg}; color:${ink}; border-radius:${w>=320?18:12}px; overflow:hidden; box-shadow:inset 0 0 0 1px rgba(255,255,255,.10); font-family:'Plus Jakarta Sans', system-ui, sans-serif;">
                    ${photoLayer}
                    ${motif}
