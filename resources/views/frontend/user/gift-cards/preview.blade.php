    ...
    <div class="gc-content">
        ...
        <div class="gc-public__card-wrap">
            <x-gift-card-design
                ...
                :show-code="true"
                :width="420"
                :image="$giftCard->template?->image"
                :background-color="$giftCard->template?->background_color"
                :text-color="$giftCard->template?->text_color"
                :ribbon-text="$giftCard->template?->ribbon_text"
            />
        </div>
