...
<script>
    (function (window, document) {
        ...
        const playGenerated = function (tune) {
            ...
            // Play near media output level. Browsers do not expose OS notification
            // volume, so we keep Web Audio loud and let the device media volume apply.
            ...
            tune.steps.forEach(function (step) {
                ...
                if (frequency > 0) {
                    ...
                    const volume = Math.max(0.05, Math.min(0.95, Number(step.volume || 0.55)));
