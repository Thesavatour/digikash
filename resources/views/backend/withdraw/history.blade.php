...
@section('withdraw_header')
    <x-admin-feature-header
        :title="__('Withdraw History')"
        :subtitle="__('View and manage all user withdrawal transactions in the system.')"
        icon="history"
    />
@endSection
                ...
                <table class="table border mb-0">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-md me-2">
                                        @isset($withdrawHistory->user->avatar)
                                            <img class="avatar-img" src="{{ asset($withdrawHistory->user->avatar) }}" height="40" alt="User Avatar" loading="lazy">
                                        @else
                    ...
                    @empty
                        <tr>
                            <td colspan="5">
                                <x-admin-not-found
                                    :title="__('No withdraw history found')"
                                    :message="__('Withdraw transactions matching the current filters will appear here.')"
                                    icon="fa-wallet"
                                />
                            </td>
                        </tr>
