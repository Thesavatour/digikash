...
@section('styles')
	<style>
		...
		.notification-template-page .notification-template-table {
			table-layout: fixed;
			min-width: 1060px;
		}

		.notification-template-page .notification-template-col--template {
			width: 46%;
		}

		.notification-template-page .notification-template-col--channels {
			width: 21%;
		}

		.notification-template-page .notification-template-col--variables {
			width: 23%;
		}

		.notification-template-page .notification-template-col--action {
			width: 10%;
		}
		...
		.notification-template-page .notification-template-item__icon .icon,
		.notification-template-page .notification-template-item__icon svg {
			width: 1.05rem;
			height: 1.05rem;
		}

		.notification-template-page .notification-template-item__body {
			min-width: 0;
		}

		.notification-template-page .notification-template-title {
			overflow: hidden;
			color: #101828;
			font-size: 0.84rem;
			font-weight: 700;
		...
		.notification-template-page .notification-template-badges {
			display: flex;
			flex-wrap: wrap;
			align-items: center;
			gap: 0.28rem;
		...
		.notification-template-page .notification-template-badges .badge,
		.notification-template-page .notification-channel-pill .badge {
			font-size: 0.56rem;
			line-height: 1;
			padding: 0.22rem 0.36rem;
		}

		.notification-template-page .notification-template-summary {
			display: -webkit-box;
			overflow: hidden;
			max-width: 100%;
			margin-top: 0.3rem;
		...
		.notification-template-page .notification-template-meta-code {
			color: #667085;
		...
		.notification-template-page .notification-channel-pill__label span {
			overflow: hidden;
			text-overflow: ellipsis;
			white-space: nowrap;
		}
		...
		.notification-template-page .notification-variable-label {
			font-size: 0.68rem;
			line-height: 1;
		}

		.notification-template-page .variable-tag {
			max-width: 9rem;
			overflow: hidden;
		...
		.notification-template-page .notification-template-action {
			white-space: nowrap;
		}

		.notification-template-page .notification-template-action .btn {
			padding: 0.34rem 0.55rem;
			font-size: 0.78rem;
			font-weight: 700;
		}

		.notification-template-page .notification-template-action .icon,
		.notification-template-page .notification-template-action svg {
			width: 0.92rem;
			height: 0.92rem;
		}
		...
		<div class="card border-0 shadow-sm mb-4 notification-template-shell">
			...
			<div class="table-responsive">
				<table class="table align-middle mb-0 notification-template-table">
					<colgroup>
						<col class="notification-template-col--template">
						<col class="notification-template-col--channels">
						<col class="notification-template-col--variables">
						@can('notification-template-manage')
							<col class="notification-template-col--action">
						@endcan
					</colgroup>
					<thead>
					<tr>
						...
						<tr>
							<td>
								<div class="notification-template-item">
									<span class="notification-template-item__icon text-{{ $template->action_type->class() }}">
										<x-icon :name="$template->icon" height="22" width="22"/>
									</span>
									<div class="notification-template-item__body">
										<div class="notification-template-title">{{ $template->name }}</div>
										<div class="notification-template-badges">
										...
										<div class="notification-template-summary">{{ $template->info }}</div>
										<div class="notification-template-meta">
											<span class="fw-semibold text-dark">{{ __('Identifier') }}:</span>
											<span class="notification-template-meta-code">{{ $template->identifier }}</span>
										</div>
									</div>
								</div>
							</td>
							...
							<td>
								<div class="d-flex align-items-center gap-2 flex-wrap mb-1">
									...
									<span class="text-muted notification-variable-label">{{ __('Placeholders') }}</span>
								</div>

								<div class="notification-variable-group mb-1">
