...
@section('content')
    <div class="remittance-admin remittance-admin--form">
                        ...
                        <div class="rmt-hero__head-body">
                            <div class="rmt-pagehead__topline">
                                ...
                                <span class="rmt-pagehead__pill rmt-pagehead__pill--success">
                                    <span class="rmt-pagehead__pill-dot"></span> {{ __('Draft') }}
                                </span>
                            </div>

                            <h1 id="rmt-hero-title" class="rmt-hero__title">{{ __('Add Corridor') }}</h1>
                            <p class="rmt-hero__subtitle">{{ __('Define a new country pair, its FX margin, fees, and payout driver.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="rmt-hero__metabox">
                        <span class="rmt-hero__meta rmt-hero__meta--driver">
                            ...
                            <span class="rmt-hero__meta-stack">
                                <span class="rmt-hero__meta-label">{{ __('Setup time') }}</span>
                                <strong class="rmt-hero__meta-value">{{ __('~2 min') }}</strong>
                            </span>
                        </span>
                        ...
                        <span class="rmt-hero__meta rmt-hero__meta--transfers">
                            ...
                            <span class="rmt-hero__meta-stack">
                                <span class="rmt-hero__meta-label">{{ __('Sections') }}</span>
                                <strong class="rmt-hero__meta-value">{{ __('6 steps') }}</strong>
                            </span>
                        </span>
                    </div>
                </div>

                {{-- RIGHT: breadcrumb (top) + decorative world map (below) --}}
                <div class="rmt-hero__side">
                    ...
                    <aside class="rmt-hero__globe" aria-hidden="true">
                        <svg class="rmt-hero__globe-svg" viewBox="0 0 1000 500" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <defs>
                                <pattern id="rmt-map-dots-create" x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse">
                                    <circle cx="2" cy="2" r="1.6" fill="#94a3b8"/>
                                </pattern>
                                <mask id="rmt-map-mask-create">
                                    {{-- North America --}}
                                ...
                                <radialGradient id="rmt-pin-blue-create" cx="50%" cy="50%" r="50%">
                                    <stop offset="0%" stop-color="#4663EE" stop-opacity="0.35"/>
                                    <stop offset="100%" stop-color="#4663EE" stop-opacity="0"/>
                                </radialGradient>
                                <radialGradient id="rmt-pin-green-create" cx="50%" cy="50%" r="50%">
                                    <stop offset="0%" stop-color="#16a34a" stop-opacity="0.35"/>
                                    <stop offset="100%" stop-color="#16a34a" stop-opacity="0"/>
                                </radialGradient>
                                <radialGradient id="rmt-pin-purple-create" cx="50%" cy="50%" r="50%">
                                    <stop offset="0%" stop-color="#6D28D9" stop-opacity="0.35"/>
                                    <stop offset="100%" stop-color="#6D28D9" stop-opacity="0"/>
                                </radialGradient>
                                <radialGradient id="rmt-pin-amber-create" cx="50%" cy="50%" r="50%">
                            ...
                            <rect x="0" y="0" width="1000" height="500" fill="url(#rmt-map-dots-create)" mask="url(#rmt-map-mask-create)" opacity="0.55"/>

                            {{-- Decorative pins on major corridor hubs --}}
                            <circle cx="294" cy="139" r="18" fill="url(#rmt-pin-blue-create)"/>
                            <circle cx="294" cy="139" r="5" fill="#4663EE"/>
                            <circle cx="294" cy="139" r="2" fill="#ffffff"/>

                            <circle cx="751" cy="184" r="18" fill="url(#rmt-pin-green-create)"/>
                            <circle cx="751" cy="184" r="5" fill="#16a34a"/>
                            <circle cx="751" cy="184" r="2" fill="#ffffff"/>

                            <circle cx="510" cy="120" r="18" fill="url(#rmt-pin-purple-create)"/>
                            <circle cx="510" cy="120" r="5" fill="#6D28D9"/>
                            <circle cx="510" cy="120" r="2" fill="#ffffff"/>

                            <circle cx="870" cy="370" r="18" fill="url(#rmt-pin-amber-create)"/>
        ...
        @include('backend.remittance.corridors._form', [
            'action'        => route('admin.remittance.corridors.store'),
            'method'        => 'POST',
            'corridor'      => $corridor,
