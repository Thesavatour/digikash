                            ...
                            @forelse($plan->features as $feature)
                                <div class="sa-feature-list__item">
                                    <span class="sa-feature-list__icon">
                                        <x-icon name="{{ $feature->isAccess() ? ($feature->isEnabled() ? 'check' : 'close') : ($feature->isBenefit() ? 'star' : 'grid-check') }}" height="16" width="16"/>
                                    </span>
                                    ...
                                    <span class="sa-feature-list__value">
                                        ...
                                        @elseif($feature->isAccess())
                                            <span class="sa-pill {{ $feature->isEnabled() ? 'sa-pill--success' : 'sa-pill--danger' }}">
                                                {{ $feature->displayValue() }}
                                            </span>
                                        @elseif($feature->isBenefit())
                                            <span class="sa-pill sa-pill--info">{{ $feature->displayValue() }}</span>
                                        @else
                                            {{ $feature->displayValue() }}
                                        @endif
                                    </span>
