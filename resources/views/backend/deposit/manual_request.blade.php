...
@section('deposit_header')
    <x-admin-feature-header
        :title="__('Manual Deposit Requests')"
        :subtitle="__('Review, approve, or reject all manual deposit requests submitted by users.')"
        icon="request"
    />
@endSection
            ...
            <table class="table caption-top mb-0">
                ...
                @empty
                    <tr>
                        <td colspan="5">
                            <x-admin-not-found
                                :title="__('No deposit requests found')"
                                :message="__('Manual deposit requests will appear here when users submit them.')"
                                icon="fa-receipt"
                            />
                        </td>
                    </tr>
