...
@section('deposit_header')
    <x-admin-feature-header
        ...
        :subtitle="__('View and manage all deposit transactions on your platform from this page.')"
        icon="history"
    />
@endSection
                ...
                <table class="table  border mb-0">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-md me-2">
                                        @isset($depositHistory->user->avatar)
                                            <img class="avatar-img" src="{{ asset($depositHistory->user->avatar) }}" height="40" alt="User Avatar" loading="lazy">
                                        @else
                    ...
                    @empty
                        <tr>
                            <td colspan="5">
                                <x-admin-not-found
                                    :title="__('No deposit history found')"
                                    :message="__('Deposit transactions matching the current filters will appear here.')"
                                    icon="fa-receipt"
                                />
                            </td>
                        </tr>
