                        ...
                        <div class="feature-mgmt-panel feature-mgmt-panel--{{ $panel }}">
                            ...
                            <div class="feature-mgmt-panel__grid">
                                ...
                                @if($supportsIdentifierMix)
                                    <div class="feature-mgmt-row feature-mgmt-row--panel feature-mgmt-row--full feature-mgmt-row--identifier-heading">
                                        <div>
                                            <span class="feature-mgmt-row__label">
                                                <i class="fa-solid fa-address-card feature-mgmt-row__icon" aria-hidden="true"></i>
                                                {{ __('Recipient Identifier Methods') }}
                                            </span>
                                            <span class="feature-mgmt-row__hint">{{ __('Choose how a recipient can be looked up on this panel. Verified-only toggles enforce verification on the matched account.') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <label class="feature-mgmt-row feature-mgmt-row--panel">
                                        <div>
                                            <span class="feature-mgmt-row__label">
                                                <i class="fa-solid fa-fingerprint feature-mgmt-row__icon" aria-hidden="true"></i>
                                                {{ __('Allow Wallet ID') }}
                                            </span>
                                            <span class="feature-mgmt-row__hint">{{ __('Accept a wallet UUID like DK-USD-XXXX-XXXX.') }}</span>
                                        </div>
                                        <div>
                                            <input type="hidden" name="panels[{{ $panel }}][identifier_methods][wallet_id]" value="0">
                                            <div class="form-check form-switch feature-mgmt-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                       name="panels[{{ $panel }}][identifier_methods][wallet_id]" value="1"
                                                       {{ $allowWalletId ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    <label class="feature-mgmt-row feature-mgmt-row--panel">
                                        <div>
                                            <span class="feature-mgmt-row__label">
                                                <i class="fa-solid fa-at feature-mgmt-row__icon" aria-hidden="true"></i>
                                                {{ __('Allow Email') }}
                                            </span>
                                            <span class="feature-mgmt-row__hint">{{ __('Accept the recipient\'s registered email.') }}</span>
                                        </div>
                                        <div>
                                            <input type="hidden" name="panels[{{ $panel }}][identifier_methods][email]" value="0">
                                            <div class="form-check form-switch feature-mgmt-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                       name="panels[{{ $panel }}][identifier_methods][email]" value="1"
                                                       {{ $allowEmail ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    <label class="feature-mgmt-row feature-mgmt-row--panel">
                                        <div>
                                            <span class="feature-mgmt-row__label">
                                                <i class="fa-solid fa-envelope-circle-check feature-mgmt-row__icon" aria-hidden="true"></i>
                                                {{ __('Email must be verified') }}
                                            </span>
                                            <span class="feature-mgmt-row__hint">{{ __('Reject lookups when the matched email is not verified.') }}</span>
                                        </div>
                                        <div>
                                            <input type="hidden" name="panels[{{ $panel }}][require_verified_email]" value="0">
                                            <div class="form-check form-switch feature-mgmt-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                       name="panels[{{ $panel }}][require_verified_email]" value="1"
                                    ...
                                    <label class="feature-mgmt-row feature-mgmt-row--panel">
                                        <div>
                                            <span class="feature-mgmt-row__label">
                                                <i class="fa-solid fa-square-phone-flip feature-mgmt-row__icon" aria-hidden="true"></i>
                                                {{ __('Allow Mobile Number') }}
                                            </span>
                                            <span class="feature-mgmt-row__hint">{{ __('Accept the recipient\'s registered mobile number.') }}</span>
                                        </div>
                                        <div>
                                            <input type="hidden" name="panels[{{ $panel }}][identifier_methods][mobile]" value="0">
                                            <div class="form-check form-switch feature-mgmt-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                       name="panels[{{ $panel }}][identifier_methods][mobile]" value="1"
                                                       {{ $allowMobile ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </label>
                                    ...
                                    <label class="feature-mgmt-row feature-mgmt-row--panel">
                                        <div>
                                            <span class="feature-mgmt-row__label">
                                                <i class="fa-solid fa-check-double feature-mgmt-row__icon" aria-hidden="true"></i>
                                                {{ __('Mobile must be verified') }}
                                            </span>
                                            <span class="feature-mgmt-row__hint">{{ __('Reject lookups when the matched mobile is not verified.') }}</span>
                                        </div>
                                        <div>
                                            <input type="hidden" name="panels[{{ $panel }}][require_verified_mobile]" value="0">
                                            <div class="form-check form-switch feature-mgmt-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                       name="panels[{{ $panel }}][require_verified_mobile]" value="1"
                                                       {{ $verifiedMobile ? 'checked' : '' }}>
                                            </div>
                                        </div>
                                    </label>
                                @endif
