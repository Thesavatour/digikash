    ...
    <div class="container-fluid px-3 px-lg-4">
        <div class="admin-header-bar">
            <div class="admin-header-start">
                ...
                <button class="header-toggler admin-header-search-toggle d-inline-flex d-sm-none"
                        type="button"
                        id="admin-header-search-toggle"
                        aria-label="{{ __('Toggle search') }}"
                        aria-controls="admin-header-search-panel"
                        aria-expanded="false"
                        title="{{ __('Search') }}">
                    <x-icon name="search" class="icon icon-lg"/>
                </button>

                <div class="admin-header-search-wrap" id="admin-header-search-panel">
