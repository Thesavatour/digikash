...
<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
	...
	<div class="sidebar-header border-bottom">
		...
		{{--
			Close button (mobile only). Handler lives in
			public/backend/js/main.js — delegated off
			[data-sidebar-close] so it survives re-renders. The
			previous inline `onclick` called Sidebar.getInstance(),
			which returns null when CoreUI hasn't yet created an
			instance on the element, causing a silent TypeError and
			the button "did nothing" on real mobile devices.
		--}}
