...
@section('p2p_content')
    <div class="p2p-refresh">
        ...
        <form method="POST" action="{{ route('admin.p2p.settings.update') }}" id="p2p-settings-form" data-settings-form>
            ...
            <h5 class="fw-bold mb-1">@lang('Trading Rules')</h5>
            <p class="text-muted small mb-3">@lang('Fees, time windows, and default trade limits applied to new orders.')</p>
            ...
            <div class="settings-grid">
                ...
                <section class="settings-panel">
                    ...
                    <div class="settings-fields">
                        <div class="settings-field">
                            <label for="min_amount">@lang('Default Min Amount')</label>
                            <div class="settings-input-wrap">
                        ...
                        <div class="settings-field">
                            <label for="max_amount">@lang('Default Max Amount')</label>
                            <div class="settings-input-wrap">
            ...
            <h5 class="fw-bold mb-1 mt-4">@lang('Compliance & Guardrails')</h5>
            <p class="text-muted small mb-3">@lang('Country availability rules that gate who can trade on the marketplace.')</p>
