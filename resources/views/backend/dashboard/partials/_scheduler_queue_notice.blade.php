...
<section class="sq-notice"
    ...
    <div class="sq-notice__grid">
        ...
        <article class="sq-notice__service sq-notice__service--queue">
            ...
            <p class="sq-notice__service-text">
                {{ __('Handles queued jobs — deposits, withdrawals, notifications, webhook deliveries. On cPanel, run it as a once-per-minute cron job that drains the queue and exits; on a VPS, keep it alive under Supervisor.') }}
            </p>
        </article>
