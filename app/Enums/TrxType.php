...
enum TrxType: string
{
    ...
    case REMITTANCE_SEND        = 'remittance_send';
    case REMITTANCE_RECEIVE     = 'remittance_receive';
    case REMITTANCE_REFUND      = 'remittance_refund';
    case MARKETPLACE_SALE       = 'marketplace_sale';
    case MARKETPLACE_PAYOUT     = 'marketplace_payout';
    case MARKETPLACE_COMMISSION = 'marketplace_commission';
    case MARKETPLACE_REFUND     = 'marketplace_refund';
    ...
    public function label()
    {
        return match ($this) {
            ...
            self::REMITTANCE_SEND        => __('International Transfer Sent'),
            self::REMITTANCE_RECEIVE     => __('International Transfer Received'),
            self::REMITTANCE_REFUND      => __('International Transfer Refund'),
            self::MARKETPLACE_SALE       => __('Marketplace Purchase'),
            self::MARKETPLACE_PAYOUT     => __('Marketplace Payout'),
            self::MARKETPLACE_COMMISSION => __('Marketplace Commission'),
            self::MARKETPLACE_REFUND     => __('Marketplace Refund'),
            default                      => __('Unknown'),
        };
    }
    ...
    public function badgeColor(): string
    {
        return match ($this) {
            ...
            self::REMITTANCE_SEND        => 'warning',
            self::REMITTANCE_RECEIVE     => 'primary',
            self::REMITTANCE_REFUND      => 'info',
            self::MARKETPLACE_SALE       => 'warning',
            self::MARKETPLACE_PAYOUT     => 'success',
            self::MARKETPLACE_COMMISSION => 'success',
            self::MARKETPLACE_REFUND     => 'info',
    ...
    public static function rankFeatureMap(): array
    {
        return [
            ...
            self::REMITTANCE_SEND->value   => 'remittance',
        ];
    }
    ...
    public function icon()
    {
        return match ($this) {
            ...
            self::REMITTANCE_SEND        => 'send-money',
            self::REMITTANCE_RECEIVE     => 'receive-money',
            self::REMITTANCE_REFUND      => 'refund',
            self::MARKETPLACE_SALE       => 'payment',
            self::MARKETPLACE_PAYOUT     => 'receive-payment-1',
            self::MARKETPLACE_COMMISSION => 'reward',
            self::MARKETPLACE_REFUND     => 'refund',
