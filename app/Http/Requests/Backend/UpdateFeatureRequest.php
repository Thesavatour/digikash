...
class UpdateFeatureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        foreach (FeatureAccessRule::PANELS as $panel) {
            ...
            $rules["panels.{$panel}.identifier_methods"]           = 'sometimes|array';
            $rules["panels.{$panel}.identifier_methods.wallet_id"] = 'nullable|boolean';
            $rules["panels.{$panel}.identifier_methods.email"]     = 'nullable|boolean';
            $rules["panels.{$panel}.identifier_methods.mobile"]    = 'nullable|boolean';
            $rules["panels.{$panel}.require_verified_email"]       = 'nullable|boolean';
            $rules["panels.{$panel}.require_verified_mobile"]      = 'nullable|boolean';
        }
