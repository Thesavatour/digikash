...
class UpdateMediaStorageProviderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug'                    => ['nullable', 'string', 'max:120', 'alpha_dash', Rule::unique('media_storage_providers', 'slug')->ignore($provider)],
