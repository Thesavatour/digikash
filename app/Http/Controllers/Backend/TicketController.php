...
class TicketController extends BaseController
{
    ...
    public function pendingTicket()
    {
        ...
        $tickets = Ticket::with(['user', 'category'])->where('status', TicketStatus::PENDING)->orderBy('created_at', 'desc')->paginate(10);
    ...
    public function inprogress()
    {
        ...
        $tickets = Ticket::with(['user', 'category'])->where('status', TicketStatus::OPEN)->orderBy('created_at', 'desc')->paginate(10);
    ...
    public function closeTicket()
    {
        ...
        $tickets = Ticket::with(['user', 'category'])->where('status', TicketStatus::CLOSED)->orderBy('created_at', 'desc')->paginate(10);
    ...
    public function history()
    {
        ...
        $tickets = Ticket::with(['user', 'category'])->orderBy('created_at', 'desc')->paginate(10);
    ...
    public function ticketShow(Ticket $ticket)
    {
        ...
        $ticket->load(['user', 'category', 'messages']);
