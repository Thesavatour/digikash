...
class Offer extends Model
{
    ...
    /**
     * Fiat currency code the offer price is quoted in. Falls back to the site
     * currency for legacy rows that predate the per-offer quote currency.
     */
    public function getQuoteCurrencyCodeAttribute(): string
    {
        ...
        $fallback = (string) (setting('site_currency', '') ?: siteCurrency('code'));

        return $fallback !== '' ? $fallback : (string) ($this->wallet?->currency?->code ?? '');
    }
