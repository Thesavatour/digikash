...
{
    /**
     * Accepted purchase-code formats:
     *   - a standard Envato hex UUID, or
     *   - a friendly demo code (DEMO-...) used when the update server has
     *     demo activation enabled.
     *
     * Shared with the installer Form Requests so client and server agree on
     * what a valid code looks like.
     */
    public const PURCHASE_CODE_PATTERN = '/^(?:[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}|demo-[a-z0-9][a-z0-9-]{2,70})$/i';
    ...
    {
        return preg_match(self::PURCHASE_CODE_PATTERN, $purchaseCode) === 1;
    }
