...
class NotificationTuneLibrary
{
    ...
    public const DEFAULT_KEY = 'alarm';
    ...
    public static function tunes(): array
    {
        return self::withPublicFiles([
            'alarm' => [
                'key'         => 'alarm',
                'label'       => 'Alarm',
                'description' => 'Loud attention-grabbing alert for important activity.',
                'steps'       => [
                    self::step(880, 140, 'square', 0.78, 40),
                    self::step(1175, 140, 'square', 0.82, 40),
                    self::step(880, 160, 'square', 0.85, 55),
                    self::step(1319, 180, 'square', 0.88, 40),
                ],
            ],
            'pulse' => [
                'key'         => 'pulse',
                ...
                'steps'       => [
                    self::step(880, 110, 'sine', 0.62, 35),
                    self::step(1175, 130, 'sine', 0.68, 35),
                ],
            ],
            'chime' => [
                'key'         => 'chime',
                ...
                'steps'       => [
                    self::step(659, 95, 'sine', 0.55, 20),
                    self::step(880, 105, 'sine', 0.58, 20),
                    self::step(1319, 145, 'sine', 0.52, 45),
                ],
            ],
            'coin' => [
                'key'         => 'coin',
                ...
                'steps'       => [
                    self::step(1047, 80, 'triangle', 0.58, 20),
                    self::step(1568, 95, 'triangle', 0.60, 35),
                    self::step(2093, 110, 'triangle', 0.48, 40),
                ],
            ],
            'ripple' => [
                'key'         => 'ripple',
                ...
                'steps'       => [
                    self::step(587, 85, 'sine', 0.48, 25),
                    self::step(740, 85, 'sine', 0.50, 25),
                    self::step(932, 95, 'sine', 0.52, 25),
                    self::step(1175, 120, 'sine', 0.50, 35),
                ],
            ],
            'prism' => [
                'key'         => 'prism',
                ...
                'steps'       => [
                    self::step(784, 100, 'triangle', 0.52, 20),
                    self::step(988, 100, 'triangle', 0.52, 20),
                    self::step(1319, 140, 'triangle', 0.48, 45),
                ],
            ],
            'arcade' => [
                'key'         => 'arcade',
                ...
                'steps'       => [
                    self::step(988, 70, 'square', 0.55, 20),
                    self::step(1319, 70, 'square', 0.52, 20),
                    self::step(1760, 90, 'square', 0.48, 45),
                ],
            ],
            'soft-bell' => [
                'key'         => 'soft-bell',
                ...
                'steps'       => [
                    self::step(523, 130, 'sine', 0.35, 35),
                    self::step(784, 170, 'sine', 0.32, 55),
                ],
            ],
            'quick-pop' => [
                'key'         => 'quick-pop',
                ...
                'steps'       => [
                    self::step(1047, 65, 'triangle', 0.58, 18),
                    self::step(784, 75, 'triangle', 0.50, 30),
                ],
            ],
            'mellow' => [
                'key'         => 'mellow',
                ...
                'steps'       => [
                    self::step(440, 120, 'sine', 0.55, 35),
                    self::step(554, 120, 'sine', 0.58, 35),
                    self::step(659, 150, 'sine', 0.52, 45),
                ],
            ],
            'signal' => [
                'key'         => 'signal',
                ...
                'steps'       => [
                    self::step(740, 90, 'sine', 0.58, 25),
                    self::step(740, 90, 'sine', 0.58, 25),
                    self::step(988, 110, 'sine', 0.55, 40),
                ],
            ],
            'success' => [
                'key'         => 'success',
                ...
                'steps'       => [
                    self::step(659, 80, 'triangle', 0.55, 20),
                    self::step(880, 90, 'triangle', 0.58, 20),
                    self::step(1175, 130, 'triangle', 0.52, 35),
                ],
            ],
            'alert' => [
                'key'         => 'alert',
                ...
                'steps'       => [
                    self::step(880, 95, 'square', 0.68, 25),
                    self::step(660, 95, 'square', 0.68, 25),
                    self::step(880, 115, 'square', 0.72, 45),
                ],
            ],
            'glass' => [
                'key'         => 'glass',
                ...
                'steps'       => [
                    self::step(1175, 75, 'sine', 0.45, 18),
                    self::step(1760, 95, 'sine', 0.42, 30),
                    self::step(2349, 115, 'sine', 0.38, 45),
                ],
            ],
            'glow' => [
                'key'         => 'glow',
                ...
                'steps'       => [
                    self::step(554, 110, 'sine', 0.48, 30),
                    self::step(740, 140, 'sine', 0.45, 45),
                ],
            ],
            'orbit' => [
                'key'         => 'orbit',
                ...
                'steps'       => [
                    self::step(660, 80, 'triangle', 0.50, 22),
                    self::step(880, 90, 'triangle', 0.50, 22),
                    self::step(660, 115, 'triangle', 0.48, 42),
                ],
            ],
            'sparkle' => [
                'key'         => 'sparkle',
                ...
                'steps'       => [
                    self::step(1319, 65, 'sine', 0.48, 18),
                    self::step(1976, 85, 'sine', 0.42, 28),
                    self::step(1568, 100, 'sine', 0.42, 38),
                ],
            ],
            'sonar' => [
                'key'         => 'sonar',
                ...
                'steps'       => [
                    self::step(784, 120, 'sine', 0.55, 85),
                    self::step(784, 140, 'sine', 0.48, 45),
                ],
            ],
            'cascade' => [
                'key'         => 'cascade',
                ...
                'steps'       => [
                    self::step(1568, 75, 'triangle', 0.48, 20),
                    self::step(1175, 85, 'triangle', 0.48, 20),
                    self::step(880, 105, 'triangle', 0.48, 35),
                    self::step(659, 125, 'triangle', 0.45, 45),
                ],
            ],
            'comet' => [
                'key'         => 'comet',
                ...
                'steps'       => [
                    self::step(740, 65, 'square', 0.55, 18),
                    self::step(988, 65, 'square', 0.55, 18),
                    self::step(1319, 95, 'square', 0.52, 38),
                ],
            ],
            'zen' => [
                'key'         => 'zen',
                ...
                'steps'       => [
                    self::step(392, 150, 'sine', 0.32, 45),
                    self::step(523, 180, 'sine', 0.28, 55),
                ],
            ],
            'vault' => [
                'key'         => 'vault',
                ...
                'steps'       => [
                    self::step(494, 100, 'triangle', 0.55, 25),
                    self::step(659, 120, 'triangle', 0.52, 25),
                    self::step(988, 145, 'triangle', 0.48, 45),
                ],
            ],
            'breeze' => [
                'key'         => 'breeze',
                ...
                'steps'       => [
                    self::step(698, 95, 'sine', 0.42, 30),
                    self::step(1047, 135, 'sine', 0.40, 55),
                ],
            ],
            'notice' => [
                'key'         => 'notice',
                ...
                'steps'       => [
                    self::step(784, 105, 'sine', 0.50, 30),
                    self::step(988, 120, 'sine', 0.48, 40),
                ],
            ],
            'matrix' => [
                'key'         => 'matrix',
                ...
                'steps'       => [
                    self::step(988, 60, 'square', 0.52, 18),
                    self::step(784, 60, 'square', 0.52, 18),
                    self::step(1175, 70, 'square', 0.52, 18),
                    self::step(1568, 90, 'square', 0.48, 40),
                ],
            ],
            'tempo' => [
                'key'         => 'tempo',
                ...
                'steps'       => [
                    self::step(659, 70, 'triangle', 0.52, 28),
                    self::step(659, 70, 'triangle', 0.52, 28),
                    self::step(880, 120, 'triangle', 0.55, 42),
                ],
            ],
            'twinkle' => [
                'key'         => 'twinkle',
                ...
                'steps'       => [
                    self::step(1047, 70, 'sine', 0.45, 18),
                    self::step(1319, 80, 'sine', 0.42, 18),
                    self::step(2093, 105, 'sine', 0.38, 38),
                ],
            ],
            'ascend' => [
                'key'         => 'ascend',
                ...
                'steps'       => [
                    self::step(523, 80, 'triangle', 0.52, 20),
                    self::step(659, 90, 'triangle', 0.52, 20),
                    self::step(784, 100, 'triangle', 0.52, 20),
                    self::step(1047, 125, 'triangle', 0.50, 45),
                ],
            ],
            'calm-drop' => [
                'key'         => 'calm-drop',
                ...
                'steps'       => [
                    self::step(880, 110, 'sine', 0.42, 35),
                    self::step(659, 150, 'sine', 0.38, 50),
                ],
            ],
            'echo' => [
                'key'         => 'echo',
                ...
                'steps'       => [
                    self::step(988, 80, 'sine', 0.50, 55),
                    self::step(988, 90, 'sine', 0.42, 55),
                    self::step(988, 105, 'sine', 0.35, 45),
                ],
            ],
            'priority' => [
                'key'         => 'priority',
                ...
                'steps'       => [
                    self::step(988, 100, 'square', 0.75, 28),
                    self::step(1175, 100, 'square', 0.78, 28),
                    self::step(988, 150, 'square', 0.82, 45),
                ],
            ],
        ]);
    }
     ...
     * @return array<string, mixed>
     */
    private static function step(float $frequency, int $milliseconds, string $type = 'sine', float $volume = 0.55, int $gap = 30): array
    {
        return [
            'frequency' => $frequency,
