...
class P2PPromotionPackageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Single transaction: the six upserts commit atomically so a
        // mid-run failure can never leave a half-seeded catalog. Keyed on
        // `name` (the natural unique key) the seeder is idempotent — running
        // it again refreshes the bundled defaults without creating dupes.
