...
class PermissionTableSeeder extends Seeder
{
    ...
    private const PERMISSION_CATALOG = [
        ...
        'remittance' => [
            'remittance-corridor-list',
            'remittance-corridor-manage',
            'remittance-transfer-list',
            'remittance-transfer-manage',
        ],
        'payment-link' => [
            'payment-link-list',
            'payment-link-manage',
    ...
    private const CATEGORY_METADATA = [
        ...
        'remittance'       => ['label' => 'International Remittance', 'icon' => 'currency-exchange', 'summary' => 'Corridors, transfers', 'description' => 'Cross-border transfer corridors, FX margin, payout gateway routing, and outbound transfer review.'],
        ...
        'media'            => ['label' => 'Media Library', 'icon' => 'palette', 'summary' => 'Files, images, storage', 'description' => 'Media uploads, reusable assets, provider configuration, and storage connection controls.'],
        ...
        'marketplace'      => ['label' => 'Marketplace', 'icon' => 'p2p_trading', 'summary' => 'Vendors, orders, commission', 'description' => 'Marketplace commission settings, vendor approvals, and order refunds.'],
    ...
    private function permissionDescription(string $permission): string
    {
        ...
        $overrides = [
            ...
            'marketplace-manage'             => 'Configure marketplace commission rate, bounds, and the commission account.',
            'marketplace-vendor-list'        => 'View marketplace vendor applications and their status.',
            'marketplace-vendor-manage'      => 'Approve or suspend marketplace vendors.',
            'marketplace-order-list'         => 'View marketplace orders and split details.',
            'marketplace-order-manage'       => 'Refund marketplace orders back to buyers.',
            ...
            'media-list'                     => 'View media assets, metadata, storage providers, and reusable file URLs.',
            'media-upload'                   => 'Upload images, documents, archives, audio, and video files to the active media provider.',
            'media-edit'                     => 'Update media titles, alt text, captions, and folder metadata.',
            'media-delete'                   => 'Delete media records and remove their stored files when allowed.',
            'media-storage-manage'           => 'Create, configure, activate, test, and remove media storage providers.',
        ];
