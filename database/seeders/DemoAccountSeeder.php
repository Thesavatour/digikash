    ...
    private function customers(Currency $defaultCurrency): array
    {
        return [
            ...
            [
                ...
                'wallets' => [
                    $defaultCurrency->code => 14250.00,
                ],
                'transactions' => [
                    $this->transaction('demo-rakib-wallet-topup', TrxType::DEPOSIT, 'Demo wallet top-up before P2P trading.', 8000.00, 20.00, AmountFlow::PLUS, TrxStatus::COMPLETED, 5),
                ],
                'login_activity' => $this->loginActivity('203.0.113.23', 'Bangladesh', 'Mobile', 'Chrome Mobile', 'Android', 3),
                'kyc_status'     => KycStatus::APPROVED,
                'kyc_notes'      => 'Demo customer KYC approved for active P2P trading.',
            ],
            [
                'legacy_emails' => [],
                'profile'       => $this->profile([
                ...
                'wallets' => [
                    $defaultCurrency->code => 9800.00,
                ],
                'transactions' => [
                    $this->transaction('demo-sadia-wallet-topup', TrxType::DEPOSIT, 'Demo wallet top-up before P2P trading.', 6000.00, 15.00, AmountFlow::PLUS, TrxStatus::COMPLETED, 7),
                ],
                'login_activity' => $this->loginActivity('203.0.113.24', 'Bangladesh', 'Desktop', 'Chrome', 'Windows', 6),
                'kyc_status'     => KycStatus::APPROVED,
                'kyc_notes'      => 'Demo customer KYC approved for active P2P trading.',
            ],
            [
                ...
                'wallets' => [
                    $defaultCurrency->code => 21500.00,
                ],
                'transactions' => [
                    $this->transaction('demo-mahin-wallet-topup', TrxType::DEPOSIT, 'Demo wallet top-up before P2P trading.', 12000.00, 30.00, AmountFlow::PLUS, TrxStatus::COMPLETED, 4),
                ],
                'login_activity' => $this->loginActivity('203.0.113.25', 'Bangladesh', 'Mobile', 'Mobile Safari', 'iOS', 2),
                'kyc_status'     => KycStatus::APPROVED,
                'kyc_notes'      => 'Demo customer KYC approved for active P2P trading.',
            ],
            [
                ...
                'wallets' => [
                    $defaultCurrency->code => 5200.00,
                ],
                'transactions' => [
                    $this->transaction('demo-priya-wallet-topup', TrxType::DEPOSIT, 'Demo wallet top-up for first P2P trade.', 3000.00, 10.00, AmountFlow::PLUS, TrxStatus::COMPLETED, 1),
                ],
                'login_activity' => $this->loginActivity('203.0.113.26', 'Bangladesh', 'Mobile', 'Chrome Mobile', 'Android', 9),
                'kyc_status'     => KycStatus::APPROVED,
                'kyc_notes'      => 'Demo customer KYC approved for first P2P trade testing.',
            ],
        ];
    }
