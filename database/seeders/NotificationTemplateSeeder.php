    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'name'        => 'Signup Bonus Credited',
                'icon'        => 'reward',
                'action_type' => NotificationActionType::APPROVED,
                'info'        => 'User is notified when their welcome / signup bonus has been credited to their wallet.',
                'user_type'   => UserType::USER,
                'variables'   => ['amount', 'name'],
                'channels'    => [
                    [
                        'channel'   => 'email',
                        'title'     => 'Welcome — your signup bonus is here!',
                        'message'   => 'Hi {name}, we\'ve credited {amount} to your wallet as a welcome bonus. Start exploring your dashboard now.',
                        'is_active' => true,
                    ],
                    [
                        'channel'   => 'push',
                        'title'     => 'Signup Bonus Received',
                        'message'   => 'You received {amount} as a welcome bonus.',
                        'is_active' => true,
                    ],
                    [
                        'channel'   => 'sms',
                        'title'     => null,
                        'message'   => 'Welcome bonus of {amount} credited to your wallet.',
                        'is_active' => false,
                    ],
                ],
            ],
        ...
        $this->call([
            WalletEarnNotificationTemplateSeeder::class,
            SubscriptionNotificationTemplateSeeder::class,
            AgentNotificationTemplateSeeder::class,
            GiftCardNotificationTemplateSeeder::class,
            RemittanceNotificationTemplateSeeder::class,
        ]);
    }
}
